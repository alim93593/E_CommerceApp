...
class _PaymentPageState extends State<PaymentPage> {
 ...
 addOrderDetails(){
  ...
  emptyCartNow(){
     ...
     List temlist = EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList);
     Firestore.instance.collection("users").document(EcommerceApp.sharedPreferences.getString(EcommerceApp.userUID))
         .updateData({
          EcommerceApp.userCartList:temlist
      }).then((value) => {
       EcommerceApp.sharedPreferences.setStringList(EcommerceApp.userCartList,temlist),
       Provider.of<CartItemCounter>(context,listen: false).displayresult()
     });
     Fluttertoast.showToast(msg: "Congratulations,Your Order Has Placed Successfully");
